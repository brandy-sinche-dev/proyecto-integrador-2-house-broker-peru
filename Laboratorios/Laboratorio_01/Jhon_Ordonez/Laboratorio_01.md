...
| **Scrum Master / Lead Engineering** | Jhon Ordonez | Facilitar Scrum, coordinar la planificación, supervisar arquitectura, GitHub Flow e integración Backend/IA. |
| **Developer — Backend / API** | Jhon Ordonez | Django + Django REST Framework, mocks y servicios de integración. |
...
| **Documentador** | Jhon Ordonez | Consolidar evidencias y documentación académica por laboratorio. |
